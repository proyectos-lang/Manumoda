...
import { Home, Upload, KanbanSquare, Scissors, Settings, User, BarChart3, Activity, Banknote, Boxes, Eye, Palette, Users, Contact, CalendarDays, LogOut } from "lucide-react"
...
export const NAV: {
  ...
  {
    key: "recepciones",
    label: "Calendario de Recepciones",
    icon: CalendarDays,
